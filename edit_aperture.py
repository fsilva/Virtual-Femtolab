...
class EditAperture(wx.Frame):
    def __init__(self, *args, **kwds):
        # begin wxGlade: EditAperture.__init__
        kwds["style"] = wx.DEFAULT_FRAME_STYLE
        wx.Frame.__init__(self, *args, **kwds)
        self.label_1 = wx.StaticText(self, -1, "New Spot after aperture =")
    ...
    def __set_properties(self):
        # begin wxGlade: EditAperture.__set_properties
        self.SetTitle("Fake Aperture Properties")
        #self.spin_ctrl_1.SetMinSize((128, 30))
        self.SetBackgroundColour(wx.SystemSettings.GetColour(wx.SYS_COLOUR_BTNFACE))
        # end wxGlade

    def __do_layout(self):
        # begin wxGlade: EditAperture.__do_layout
        sizer_1 = wx.BoxSizer(wx.VERTICAL)
        sizer_2 = wx.BoxSizer(wx.VERTICAL)
        sizer_4 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_5 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_5.Add(self.label_1, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 5)
        sizer_5.Add(self.text_ctrl_1, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 5)
    ...
    def set_info(self,element,refresh_function):
        ...
        self.text_ctrl_1.SetValue(str(element.new_spot*1000))

    def refresh_click(self, event): # wxGlade: EditAperture.<event_handler>
        value = float(self.text_ctrl_1.GetValue())*0.001
        self.element.new_spot = value
        self.refresh_function()
        if(not event is None):
            event.Skip()

    def done_click(self, event): # wxGlade: EditAperture.<event_handler>
        self.refresh_click(None)
        self.Close()
        event.Skip()

# end of class EditAperture
